...
<head>
    ...
    <title>403 - {{ __("view-suite::messages.Unauthorized access") }}</title>
...
<section class="relative min-h-screen bg-gray-900 overflow-hidden flex items-center justify-center mb-16 p-6">
    ...
    <div class="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <span class="relative">
          <span class="absolute inset-0 text-purple-400 opacity-70 animate-glitch-1">403</span>
          <span class="absolute inset-0 text-cyan-400 opacity-70 animate-glitch-2">403</span>
          <span class="relative">403</span>
        </span>
            </h1>
        </div>
