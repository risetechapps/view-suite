...
<head>
    ...
    <title>429 - {{ __('view-suite::messages.Many requests') }}</title>
...
<section class="relative min-h-screen bg-gray-900 overflow-hidden flex items-center justify-center mb-16 p-6">
    ...
    <div class="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <span class="relative">
          <span class="absolute inset-0 text-purple-400 opacity-70 animate-glitch-1">429</span>
          <span class="absolute inset-0 text-cyan-400 opacity-70 animate-glitch-2">429</span>
          <span class="relative">429</span>
        </span>
            </h1>
        </div>
        ...
        <h2 class="text-3xl md:text-5xl font-bold text-white mb-6">
            {{ __("view-suite::messages.Many requests") }}
        </h2>

        <!-- Description -->
        <p class="text-gray-400 text-lg mb-10">
            {{ __("view-suite::messages.Oops! We're receiving too many requests at once. Please try again in a few moments.") }}
        </p>
    </div>
